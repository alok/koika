...
Require Import rv_cache_isolation.RVEncoding.
Require Import rv_cache_isolation.Scoreboard.
Require Import rv_cache_isolation.Multiplier.
Require Import rv_cache_isolation.RegFile.
...
Module RV32Core.
  ...
  Definition rl_purge : uaction reg_t ext_fn_t :=
    {{ guard (read0(purge) == enum purge_state { Purging });
       ...
       f2d.(fromFetch.reset_all)();
       f2dprim.(waitFromFetch.reset_all)();
       d2e.(fromDecode.reset_all)();
       e2w.(fromExecute.reset_all)();
       fromMMIO.(MemResp.reset_all)();
       fromIMem.(MemResp.reset_all)();
       fromDMem.(MemResp.reset_all)();
       `reset_scoreboard`;
