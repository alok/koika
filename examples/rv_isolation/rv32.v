...
Module Package.
  ...
  (* Use Koika's verified compiler to circuits. *)
  Definition circuits :=
    compile_scheduler rules rule_external schedule.

  (* Koika package for simulation *)
  Definition koika_package :=
    {| koika_reg_types := R; (* registers *)
       koika_reg_init := r enclave_params.(_core_init0).(machine_pc)
                           ...
                           Ob~0~0 Ob~0;
       koika_ext_fn_types := Sigma; (* external functions *)
       koika_rules := rules;
